package org.bitbucket.adventofcode2077

import org.amshove.kluent.`should be equal to`
import org.bitbucket.adventofcode2017.Day07
import org.jetbrains.spek.api.Spek
import org.jetbrains.spek.api.dsl.describe
import org.jetbrains.spek.api.dsl.it
import org.jetbrains.spek.api.dsl.on

object Day07Test : Spek({
    describe("DAY 07") {
        val input = """
            keztg (7)
            uwbtawx (9)
        ...
        on("testing first task") {
            it("should match expected output for sample input") {
                day07.first("""
                    ...
                    gyxo (61)
                    cntj (57)
                    """) `should be equal to` "tknk"
            }
            it("should print answer for first task") {
                println(day07.first(input))
