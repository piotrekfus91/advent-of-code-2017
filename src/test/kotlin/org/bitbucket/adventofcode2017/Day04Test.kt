...
jwfm ptjwrbl hhuv uolz adyweh qpj wxyogp igvnojq jmfw pqs fsnirby
        ...
        on("testing first task") {
            it("should test duplicates") {
                day04.containsDuplicates("aa bb cc dd ee").shouldBeFalse()
                day04.containsDuplicates("aa bb cc dd aa").shouldBeTrue()
                day04.containsDuplicates("aa bb cc dd aaa").shouldBeFalse()
            }
            it("should count non duplicates") {
                day04.first("""
                    aa bb cc dd aa
                """.trimIndent()) `should be equal to`  0
                day04.first("""
                    aa bb cc dd ee
                """.trimIndent()) `should be equal to`  1
                day04.first("""
                    aa bb cc dd ee
                    aa bb cc dd aa
                """.trimIndent()) `should be equal to`  1
                day04.first("""
                    ...
                    aa bb cc dd aa
                    aa bb cc dd aaa
                """.trimIndent()) `should be equal to`  2
            }
            it("should print answer for first task") {
                println(day04.first(input))
            }
        }

        on("testing second task") {
            it("should test anagrams") {
                day04.containsAnagrams("abcde fghij").shouldBeFalse()
                day04.containsAnagrams("abcde xyz ecdab").shouldBeTrue()
                day04.containsAnagrams("a ab abc abd abf abj").shouldBeFalse()
                day04.containsAnagrams("iiii oiii ooii oooi oooo").shouldBeFalse()
                day04.containsAnagrams("oiii ioii iioi iiio").shouldBeTrue()
            }
            it("should count non anagrams") {
                day04.second("""
                    abcde fghij
                """.trimIndent()) `should be equal to` 1
                day04.second("""
                ...
                """.trimIndent()) `should be equal to` 3
                day04.second("""
                    abcde fghij
                    abcde xyz ecdab
                    a ab abc abd abf abj
